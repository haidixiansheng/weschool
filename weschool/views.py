...
def detail(request, course_id):
    try:
        ...
        raise Http404
    return render_to_response('course_detail.html', {'exams': exams, 'course' : course, 'user': request.user})
...
def action(request, exam_id):
    ...
    try:
        ...
        raise Http404
    return render_to_response('exam_action.html', {'exam': exam, 'questions_list' : questions_list, 'user': request.user })
